...
import RecommendationEngine4Controller, {
  Props,
  configJSON,
} from "./RecommendationEngine4Controller";

export default class RecommendationEngine4 extends RecommendationEngine4Controller {
