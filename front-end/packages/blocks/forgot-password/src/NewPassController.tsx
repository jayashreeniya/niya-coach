...
import {imgPasswordVisible , imgPasswordInVisible, bgPassImg, enterNewPassImg, passCreatedSuccessfully } from "./assets"
...
> {
  ...
  labelTxtNewPass:string=configJSON.labelTextNewPassRecovery
  ...
  buttonTextBacktoLogin:string=configJSON.buttonTextBacktoLogin;
  ...
  constructor(props: Props) {
    ...
    this.state = {
      accountType: "sms",
      accountStatus: "ChangePassword",// "ChooseAccountType",
      emailValue: "",
      phoneValue: "",
  ...
  async receive(from: string, message: Message) {
    if (getName(MessageEnum.NavigationPayLoadMessage) === message.id) {
      ...
      console.log("entered 3",responseJson,responseJson!==undefined);
      setTimeout(() => {
        this.setState({loading:false})
      }, 500);
      if (responseJson !== undefined ) {
        console.log("entered 3",responseJson);
        // this.setState({
        //   accountStatus: "Confirmation"
        // });
      
         this.props.navigation.navigate('PasswordCreatedSuccessfully')
 ...
 async componentWillUnmount() {
  ...
  bgImgProps={
    source:bgPassImg      //backgImg
  }
  setNewPassImgProps={
    source:enterNewPassImg      //backgImg
  }
setPasspassCreatedSuccessfullyImg={
  source:passCreatedSuccessfully
}
  // Customizable Area End
}
