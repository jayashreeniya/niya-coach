...
class WheelOfFortune extends Component<{ goBack: () => void }, any> {
  ...
  _onPress = () => {
    ...
    Animated.timing(this._angle, {
      ...
      this.props.getWinner(winnerIndex);
    });
  };

  _textRender = (x: number, y: number, number: any, i: number) => (
    <Text
      x={x - number.length * 5}
      y={y - 80}
      fill={
        ...
        <Animated.View
          ...
          <AnimatedSvg
            ...
            <G y={width / 2} x={width / 2}>
              {this._wheelPaths.map((arc: any, i: number) => {
    ...
    return (
      <View style={styles.outer}>
        ...
        >
          ...
          <Typography color="white" size={18} font="MED" align="center">Spin the wheel</Typography>
        </LinearGradient>
        <View style={styles.container}>
          <TouchableOpacity
            activeOpacity={1}
        ...
        <View style={{ flexDirection: "row", alignItems: "center", padding: dimensions.wp(5) }}>
          <Button
            style={{ width: "40%" }}
            onPress={() => {
          ...
          >
            {this.state.finished ? "Play Again" : "Spin"}
          </Button>
          {(this.state.finished) ? (
            <Button
