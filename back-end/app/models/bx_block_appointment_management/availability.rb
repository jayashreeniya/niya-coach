module BxBlockAppointmentManagement
  class Availability < ApplicationRecord
    ...
    has_many :availability_slots, class_name: 'BxBlockAppointmentManagement::AvailabilitySlot',dependent: :destroy
    ...
    after_commit :set_available

    def set_available
      BxBlockAppointmentManagement::AvailabilitySlot.where(availability_id: self.id).delete_all
    end  
    ...
    def slots_list
      ...
      slots = BxBlockAppointmentManagement::TimeSlotsCalculator.new.calculate_time_slots(
        availability.start_time, availability.end_time, 14
      )
    ...
    def update_slot_count
      ...
      available_slots_count = self.timeslots.count
    ...
    def create_time_slots
      new_time_slots = TimeSlotsCalculator.new.calculate_time_slots(
        self.start_time, self.end_time, 14
      )
