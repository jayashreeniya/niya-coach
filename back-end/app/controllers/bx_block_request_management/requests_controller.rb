module BxBlockRequestManagement
  class RequestsController < ApplicationController
    ...
    def index
      ...
      if params[:filter_by_request].present?
        valid_filters = %w[pending accepted rejected]
        if valid_filters.include?(params[:filter_by_request])
          requests = requests.public_send(params[:filter_by_request])
        end
      end
