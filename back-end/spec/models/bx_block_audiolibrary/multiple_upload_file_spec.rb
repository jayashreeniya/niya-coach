...
RSpec.describe BxBlockAudiolibrary::MultipleUploadFile, type: :model do
  let(:choose_file) {BxBlockAudiolibrary::MultipleUploadFile.new(choose_file: :video)}
  describe "Associations" do
    it { should have_many(:file_types) }
    it { should accept_nested_attributes_for(:file_types) }

    it "should have many focus_areas" do
      answer =  BxBlockAudiolibrary::MultipleUploadFile.reflect_on_association(:assesment_test_type_answer)
